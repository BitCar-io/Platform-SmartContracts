...
module.exports = function(deployer, network, accounts) {
    ...
    if(network !== "rinkeby" && network !== "ropsten") {
        console.log(chalk.yellow(`Not running ${__filename} as network is not rinkeby or ropsten`));
        return;
    }
    ...
    deployer.then(async () => {
        ...
        await addToTrader(trader0, admin0, true, web3, users.ownerAddr, users.coldStorageTrader0, allWhitelist.code);
